  ...
  useEffect(() => {
    const fetchVideoData = async () => {
      try {
        ...
        buttonsTop:[
    {
    full: `<a href="{https://verisart.com/works/${nombre}" target="_blank" data-tooltip="I am a custom button" class="mvp-contr-btn mvp-btn-reset my-custom-button"><svg viewBox="0 0 512 512"><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="400" font-family="Arial" font-weight="bold">V</text></svg></a>`,    
    },
